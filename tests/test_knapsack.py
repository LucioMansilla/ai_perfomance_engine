import pytest
from local.problems.knapsack import KnapSackProblem, KnapsackState, PutInKnapSack
...
is_enabled_actions_config = [
    (
        KnapSackProblem(KnapsackState([0, 0, 0], [1, 2, 3], 5, [1, 2, 3])),
        (PutInKnapSack(0), PutInKnapSack(1), PutInKnapSack(2)),
    ),
    (
        KnapSackProblem(KnapsackState([1, 0, 0], [1, 2, 3], 5, [1, 2, 3])),
        (PutInKnapSack(1), PutInKnapSack(2)),
    ),
    (
        KnapSackProblem(KnapsackState([1, 1, 0], [1, 2, 3], 5, [1, 2, 3])),
        (PutInKnapSack(2),),
    ),
